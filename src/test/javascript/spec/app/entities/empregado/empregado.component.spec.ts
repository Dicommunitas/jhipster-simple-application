...
import { EmpregadoComponent } from 'app/entities/empregado/empregado.component';
...
describe('Component Tests', () => {
  describe('Empregado Management Component', () => {
    let comp: EmpregadoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EmpregadoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.empregados && comp.empregados[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
