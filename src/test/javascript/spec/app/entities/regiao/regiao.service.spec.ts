...
describe('Service Tests', () => {
  describe('Regiao Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(RegiaoService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Regiao(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Regiao', () => {
        ...
        service.create(new Regiao()).subscribe(resp => (expectedResult = resp.body));
