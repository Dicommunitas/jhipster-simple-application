...
import { TrabalhoComponent } from 'app/entities/trabalho/trabalho.component';
...
describe('Component Tests', () => {
  describe('Trabalho Management Component', () => {
    let comp: TrabalhoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TrabalhoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.trabalhos && comp.trabalhos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
